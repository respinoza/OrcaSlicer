...
if (MSVC)
    ...
    ExternalProject_Add(dep_MPFR
        ...
        BUILD_IN_SOURCE ON
        CONFIGURE_COMMAND bash -c "autoreconf -f -i && env \"CC=${CMAKE_C_COMPILER}\" \"CXX=${CMAKE_CXX_COMPILER}\" \"CFLAGS=${_mpfr_ccflags}\" \"CXXFLAGS=${_mpfr_ccflags}\" \"LDFLAGS=${CMAKE_EXE_LINKER_FLAGS}\" ./configure ${_cross_compile_arg} --prefix=${DESTDIR} --enable-shared=no --enable-static=yes --with-gmp=${DESTDIR} ${_mpfr_build_tgt}"
