                    ...
                    [tool_number, this, &current_layer_id](unsigned int id, const std::vector<float>& time_diffs) {
                        ...
                        */
                        if (this->m_is_XL_printer) {
                            ...
                            // Snapmaker: apply the printer's delta_temperature offset to preheat commands
...
void GCodeProcessor::apply_config(const PrintConfig& config)
{
    ...
    for (size_t i = 0; i < filament_count; ++ i) {
        ...
        m_filament_nozzle_temp_first_layer[i] = static_cast<int>(get_value_at(config, config.nozzle_temperature_initial_layer, ConfigFlowDomain::Filament, i));
        m_filament_nozzle_temp[i]      = static_cast<int>(get_value_at(config, config.nozzle_temperature, ConfigFlowDomain::Filament, i));
