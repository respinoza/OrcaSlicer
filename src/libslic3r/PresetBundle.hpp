...
public:
    ...
    // Snapmaker: legacy sync used by the fork's filament sync (empty-slot handling)
    ...
    //orca: the generic 'custom' bundle (still referenced by upstream code: apply_vendor_config, ConfigWizard, GCodeViewer)
