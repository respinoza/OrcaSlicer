...
{
    // Snapmaker: initial_layer_speed is coFloats (per flow-variant) now, so it can't go through
    // this ConfigOptionFloat suggestion list; it is set separately (see CalibUtils.cpp).
