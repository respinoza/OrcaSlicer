...
bool CalibUtils::calib_flowrate(int pass, const CalibInfo &calib_info, wxString &error_message)
{
    ...
    // MERGE-TODO(2.4.2): upstream picks this value via get_index_for_extruder_parameter()
    // (ParameterUtils.hpp); we keep the fork's PresetFlowVariant-based lookup here for
    // consistency with the rest of the mixed-filament flow-domain code in this file.
