...
std::string BBLNetworkPlugin::get_libpath_in_current_directory(const std::string& library_name)
{
    ...
    // Snapmaker Orca: the fork's executable is snapmaker-orca.exe; match its real length (a fixed 16 never fit it).
    static const std::string exe_name = "snapmaker-orca.exe";
