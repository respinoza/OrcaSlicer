...
void DropDown::Invalidate(bool clear)
{
    ...
    // Snapmaker (Linux crash guard): clamp a stale selection instead of asserting.
...
void DropDown::messureSize()
{
    ...
    // Fix for GNOME Platform 48 X11 backend: never call gtk_window_resize with an invalid size
