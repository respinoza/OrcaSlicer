...
public:
    ...
    // Fork name kept as an alias: upstream renamed on_filaments_change() to on_filament_count_change().
    void on_filaments_change(size_t num_filaments) { on_filament_count_change(num_filaments); }
...
private:
    ...
    // ams_btn is declared at the top of the class (upstream moved it there).
...
public:
    ...
    // Fork name kept as an alias: upstream renamed on_filaments_change() to on_filament_count_change().
    void on_filaments_change(size_t extruders_count) { on_filament_count_change(extruders_count); }
