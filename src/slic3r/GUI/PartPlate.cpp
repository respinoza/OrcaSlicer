...
// Snapmaker fork note: the fork's resolve_sparse_infill_filament() helper (object sparse infill
// filament 0 = inherit the global one) is subsumed by upstream 2.4.x's *_filament_id keys, where 0
// already means "inherit" in get_extruders()/get_extruders_under_cli() below.
