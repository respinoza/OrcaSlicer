...
public:
    ...
    wxBoxSizer *create_item_checkbox(wxString title, wxString tooltip, std::string param, const wxString secondary_title = "", const wxString wiki_url = "", std::function<bool(bool new_val, bool old_val)> confirm_cb = nullptr);
